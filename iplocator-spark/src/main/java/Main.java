...
public class Main {
  ...
  private static final PairFunction<String, String, String> IP_MAPPER = new PairFunction<String, String, String>() {
    @Override
        ...
        try {
          ...
          if (response != null && response.getCity() != null) {
            ...
            if (city.getName() != null) {
              return new Tuple2<>(city.getName(), "1" + ";" + coord);
            }
          }
  ...
  @SuppressWarnings("serial")
  private static final Function2<String, String, String> IP_REDUCER = new Function2<String, String, String>() {
    @Override
